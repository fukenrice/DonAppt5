...
public class MyGlobals {
    ...
    public void setupNavDrawer(Context ctx, Activity activity, NavigationView navigationView, DrawerLayout gdrl) {
        drawerlayout = gdrl;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.list:
                        ...
                        break;
                    case R.id.owned_list:
                        Toast.makeText(ctx, "Charity List", Toast.LENGTH_SHORT).show();
                        Intent intent6 = new Intent(ctx, OwnedCharityListActivity.class);
